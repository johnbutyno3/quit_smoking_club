...
class _MitigationPageState extends State<MitigationPage> {
  ...
  void initState() {
    super.initState();
    // Games/GameHub is an internal game module, never a content category.
    if (!_isGameHub) {
      _loadCategoryData();
    }
  }
  ...
  Widget build(BuildContext context) {
    // Defensive routing: even if an old caller still sends "Games" or
    // "GameHub" into MitigationPage, it must never enter the content system.
